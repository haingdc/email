        ...
        <form id="search">
          <fieldset>
            ...
            <span className="find-btn">
              {/* prettier-ignore */}
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14"><use xlinkHref="#icon-search"></use></svg>
            </span>
            {/* prettier-ignore */}
            <span className="x" ><svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
